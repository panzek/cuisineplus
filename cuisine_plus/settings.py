"""
Django settings for cuisine_plus project.
...
ALLOWED_HOSTS = ['cuisine-plus.herokuapp.com', 'localhost']
...
ROOT_URLCONF = 'cuisine_plus.urls'
...
WSGI_APPLICATION = 'cuisine_plus.wsgi.application'
